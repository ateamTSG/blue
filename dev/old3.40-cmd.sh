...
$OC new-app -n $PROJ --name=app $CR/rocketchat:latest -l app=rc -e ROOT_URL='http://localhost' -e MONGO_OPLOG_URL='mongodb://db:27017/local' -e MONGO_URL='mongodb://db/rocketchatdb'
